  ...
  theme.VariantAvailability = (function() {
    ...
    availability.prototype = Object.assign({}, availability.prototype, {
      init: function() {
        ...
        // console.log(this.variantSelectors,'this.variantSelectors');
        // console.log(this.variantsObject,'this.variantsObject');
        // console.log(this.currentVariantObject,'this.currentVariantObject');
        ...
        // this.clickToWatchEta(this.currentVariantObject,this.variantsObject)
      },
      ...
      setAvailability: function(evt, variant) {
        ...
        if (evt) {
          ...
          variants = Object.assign({}, {variant}, availableVariants);
        }
      ...
      // 默认货期显示
      clickToWatchEta(val,list){
        var expressageBox = document.getElementById('expressage_box') || document.getElementById('expressage_box-modal')
        var paragraphTags = expressageBox.getElementsByTagName("p");
          ...
          if (currentVariantJson) {
            ...
            if (variantType) {
              new theme.VariantAvailability({
                ...
                variantSelectors: this.container.querySelectorAll(this.selectors.singleOptionSelector),
