...
window.theme = window.theme || {}, window.Shopify = window.Shopify || {}, theme.config = {
    ...
    function () {
        ...
        theme.PriceRange = function () {
            ...
            function t(e) {
                this.type = e.type, this.variantSelectors = e.variantSelectors, this.variantsObject = e.variantsObject, this.currentVariantObject = e.currentVariantObject, this.container = e.container, this.init()
            }
            return t.prototype = Object.assign({}, t.prototype, {
                init: function () {
                ...
                setAvailability: function (e, t) {
                    ...
                    for (var l in this.container.querySelectorAll(".variant-input-wrap").forEach(t => {
                        ...
                        if (i.hasOwnProperty(l)) {
                            ...
                            h && "option1" !== s && n.option1.push({
                                value: h,
                                soldOut: p
                            }), u && "option2" !== s && n.option2.push({
                                value: u,
                                soldOut: p
                            }), m && "option3" !== s && n.option3.push({
                                value: m,
                                soldOut: p
                            })
                        } for (var [f, g] of Object.entries(n)) this.manageOptionState(f, g)
                },
